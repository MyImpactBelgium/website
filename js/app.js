...
$(document).ready(function() {
    ...
    var buttonConfirmVoteMicroBFR = $('#button-confirm-vote-micro-b-fr');
    var buttonConfirmVoteCoffeeFR = $('#button-confirm-vote-coffee-fr');
    var buttonConfirmVoteFruitFR = $('#button-confirm-vote-fruit-fr');
    var buttonConfirmVoteCustomFR = $('#button-confirm-vote-custom-fr');
    var buttonConfirmVoteMicroBNL = $('#button-confirm-vote-micro-b-nl');
    var buttonConfirmVoteCoffeeNL = $('#button-confirm-vote-coffee-nl');
    var buttonConfirmVoteFruitNL = $('#button-confirm-vote-fruit-nl');
    var buttonConfirmVoteCustomNL = $('#button-confirm-vote-custom-nl');
    var confirmVote = $('#confirm-vote');


    buttonConfirmVoteMicroBFR.click(function(event) {
        ga('send',
            'event',
            'vote button',
            'micro brewery',
    ...
    buttonConfirmVoteCoffeeFR.click(function(event) {
        ga('send',
            'event',
            'vote button',
            'coffee',
    ...
    buttonConfirmVoteFruitFR.click(function(event) {
        ga('send',
            'event',
            'vote button',
            'fruit brewery',
    ...
    buttonConfirmVoteCustomFR.click(function(event) {
        ga('send',
            'event',
            'vote button',
            'custom FR',
        ...
        buttonConfirmVoteMicroBNL.click(function(event) {
        ga('send',
            'event',
            'vote button',
            'micro brewery',
    ...
    buttonConfirmVoteCoffeeNL.click(function(event) {
        ga('send',
            'event',
            'vote button',
            'coffee',
    ...
    buttonConfirmVoteFruitNL.click(function(event) {
        ga('send',
            'event',
            'vote button',
            'fruit brewery NL',
    ...
    buttonConfirmVoteCustomNL.click(function(event) {
        ga('send',
            'event',
            'vote button',
            'custom',
